                                ...
                                <div class="jumbotron">
                                    ...
                                    <form>
                                        ...
                                        <button type="button" onclick="toll_collect()" class="btn btn-primary pull-right">
                                            <span class="glyphicon glyphicon-shopping-cart"></span> Use Street</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="jumbotron">
                                    ...
                                    <form>
                                        ...
                                        <button type="button" onclick="car_wash()" class="btn btn-primary pull-right">
                                            <span class="glyphicon glyphicon-shopping-cart"></span> Wash Car</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="jumbotron">
                                    ...
                                    <form>
                                        ...
                                        <button type="button" onclick="car_parking()" class="btn btn-primary pull-right">
                                            <span class="glyphicon glyphicon-shopping-cart"></span> Park Car</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="jumbotron">
                                    ...
                                    <form>
                                        ...
                                        <button type="button" onclick="car_uber()" class="btn btn-primary pull-right">
                                            <span class="glyphicon glyphicon-shopping-cart"></span> Go UBER</button>
                                    </form>
                                </div>
                            </div>
                        </div>
